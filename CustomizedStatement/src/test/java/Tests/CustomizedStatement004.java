...
public class CustomizedStatement004 extends BaseClass {
	...
	if(actualmsg.equals(Expectmsg))
	{
		...
		System.out.println("Check Customized Statement with InValid inputs Test passed");
	}
	else
	{
		//scrnShot(driver,"CStatement001_BUG");
		System.out.println("Check Customized Statement with InValid inputs Test Failed");
	}
